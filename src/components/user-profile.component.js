...
export default class SignUpComponent extends Component {
    ...
    getUserDataById = async () => {
        try {
            const response = await axios.get(
                'http://localhost:3001/login/GetUserById/' + localStorage.getItem("userId")
            );
            this.setState({
    ...
    onSubmit = async (e) => {
        ...
        try {
            await axios.put('http://localhost:3001/login/UpdateUser', objectData);         
            toast.success("User Profile updated Successfully!",{transition:Flip,autoClose:3000});
                setTimeout(function () {
                ...
                <div>
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <img src={this.state.profilePath} alt="Profile" className="rounded-circle" />
                        </div>
                        <div className="form-group">
